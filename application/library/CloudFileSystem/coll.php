...
class QColl implements Iterator, ArrayAccess, Countable
{
    ...
    function last()
    {
        ...
        // LC_MSG: "%s" 集合中没有任何对象.
        throw new Exception(__('"%s" 集合中没有任何对象.', $this->_type));
    }
    ...
    function append($data)
    {
        ...
        else
        {
            ...
            throw new Exception(__('"%s()" 的参数 "%s" 必须是 "%s"，但实际提供的是 "%s".',
    ...
    protected function _checkType($object)
    {
        ...
        throw new Exception(__('集合只能容纳 "%s" 类型的对象，而不是 "%s" 类型的值.', $this->_type, $type));
    }
